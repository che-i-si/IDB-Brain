...
LABEL_ORDER = ['출하 승인 대상', '주요 모니터링 대상', '조건부 사용 대상', '사용 재검토 대상']
CUTOFF_LINES = [
    (0.80, "dash",    "#2ecc71", "출하 승인 (0.80)"),
    (0.60, "dot",     "#f39c12", "주요 모니터링 (0.60)"),
    (0.50, "dashdot", "#e67e22", "조건부 사용 (0.50)"),
]

def assign_label(p):
    if p >= 0.80:   return '출하 승인 대상'
    elif p >= 0.60: return '주요 모니터링 대상'
    elif p >= 0.50: return '조건부 사용 대상'
    else:           return '사용 재검토 대상'
...
st.title("ProviQ (AI-based Viability Intelligence for Bioprocessing)")
